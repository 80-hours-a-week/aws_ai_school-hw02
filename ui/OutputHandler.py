...
class OutputHandler:
    ...
    def print_message(message: str, style: str = 'normal'):
        logging.basicConfig(filename="log/outputhandler.log", filemode="at", format="%(asctime)s - %(levelname)s - %(message)s", level=logging.DEBUG)
    ...
    def print_log(filename: str):
        outputhandlerger = Logger("log/outputhandler.log")
        outputhandlerger.get_log()
        outputhandlerger.print_log()
    """